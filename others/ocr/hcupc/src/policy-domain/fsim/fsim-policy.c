...
static ocrPolicyCtx_t * cloneOcrPolicyCtxXE (ocrPolicyCtx_t * ctxIn, ocrPolicyMsgType_t type) {
    ocrPolicyCtxXE_t* ctxOut = checkedMalloc (ctxOut, sizeof(ocrPolicyCtxXE_t));
    memcpy(ctxOut, ctxIn, sizeof(ocrPolicyCtxXE_t));
    ((ocrPolicyCtx_t *)ctxOut)->type = type;
    return (ocrPolicyCtx_t*) ctxOut;
}

static ocrPolicyCtx_t * cloneOcrPolicyCtxCE (ocrPolicyCtx_t * ctxIn, ocrPolicyMsgType_t type) {
...
static ocrPolicyCtx_t * cloneOcrPolicyCtxMasteredCE (ocrPolicyCtx_t * ctxIn, ocrPolicyMsgType_t type) {
