...
static counter_t total_steals;
static counter_t total_failed_steals;
...
int main(int argc, char *argv[]) {
  ...
  ss_finalize(total_time, total_steals, total_failed_steals);
