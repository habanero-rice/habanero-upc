...
/*
   ...
   SEDOV_SYNC_POS_VEL_NONE // YZ: I think thisis the default value!
...
// YZ: Post the non-blocknig receives for the messages,
...
// YZ: Not used unless "SEDOV_SYNC_POS_VEL_LATE" is defined, which is not
